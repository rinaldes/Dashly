...
<template>
  <main>
    <section class="bg-[#f1f1f1]">
      <div
        class="container flex flex-col lg:flex-row items-center py-16 lg:py-20 gap-10"
      >
    ...
    <section ref="searchSection" class="py-12 lg:py-20 container px-8 lg:px-32">
      ...
      <div class="relative mb-8 max-w-xl group">
        <input
          ...
          class="w-full px-4 py-3 pr-12 rounded-md border border-gray-300 focus:outline-none focus:border-dodgeroll-gold focus:ring-1 focus:ring-dodgeroll-gold transition-all duration-300 ease-in-out group-focus-within:shadow-lg group-focus-within:border-dodgeroll-gold"
        />
        <Icon
          name="mdi:magnify"
          class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-dodgeroll-gold transition-colors duration-300"
          size="24"
        />
      </div>
      ...
      <!-- Pagination Controls -->
      <div
        class="flex items-center gap-4 mt-8 justify-center md:justify-between"
      >
        ...
        <span class="text-lg text-gray-500 hidden md:block"
          >Page {{ currentPage }} of {{ totalPages }} pages</span
        >
      </div>
    </section>
  </main>
